							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-success mail_fees" type="button"  data-id="<?php echo htmlspecialchars($data_json); ?>"> <i class="fa fa-envelope"></i></button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.mail_fees').click(function(){
    if (confirm("Are you sure you want to send an email?")) {
        var jsonData = JSON.stringify($(this).data('id'));
        window.location.href = "manage_mail.php?data=" + encodeURIComponent(jsonData);
    }
});
