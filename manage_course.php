...
<form action="" id="manage-course" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-6">
            ...
            <div class="">
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="ft" name="fee-type" class="form-control">
                </div>
                <div class="form-group">
                    <label for="" class="control-label">Amount</label>
                    <input type="number" step="any" min="0" id="amount" name="amount" class="form-control text-right">
                </div>
                <div class="form-group">
                    <label for="" class="control-label"> Due  Amount (Per Amount)</label>
                    <input type="number" step="any" min="0" id="due-amount" name="due-amount" class="form-control text-right">
                </div>
                <div class="form-group">
                    <label for="" class="control-label">Due last date</label>
